...
public class JobContext {
  ...
  // Parameters about chunking settings
  private int chunkNumX = 0;
  private int chunkNumY = 0;
  
  // set and get methods of the number of chunks along x direction
  public void setChunkNumX(int x) {
	  chunkNumX = x;
  }
  ...
  // set and get methods of the number of chunks along y direction
  public void setChunkNumY(int y) {
	  chunkNumY = y;
  }
