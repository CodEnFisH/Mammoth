...
public interface TaskUmbilicalProtocol extends VersionedProtocol {
	 ...
	 * for HADOOP-4759 Version 16 Added numRequiredSlots to TaskStatus for
	 * MAPREDUCE-516 Version 17 Change in signature of getTask() for HADOOP-5488
	...
	/**
	 * For Mammoth:
	 * 	Need to monitor the progress of each map task in detail
	 * *
	 */
	long updateDetailProgress(TaskAttemptID taskid, long processedCounter);
}
